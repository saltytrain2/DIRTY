...
try:
    from ghidra_types import TypeLib, TypeLibCodec, TypeInfo
    from ghidra_variable import Variable
except ImportError:
    from .ghidra_types import TypeLib, TypeLibCodec, TypeInfo
    from .ghidra_variable import Variable
...
#     @classmethod
#     def from_item(cls, item, ast: "AST") -> "Statement":
...
#     @classmethod
#     def from_item(cls, item, ast: "AST") -> "Expression":
#         return cls(node_id=ast.next_id())
